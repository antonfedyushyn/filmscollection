...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/admin", "/addFilm", "/addNewFilm", "/addYear", "/addGenre", "/addCountry", "/uploadPosterFile",
                        "/uploadImageFiles", "/uploadVideoFile", "/modifyFilm", "/editFilm", "/deleteFile", "/removeFilm")
                    .hasRole("ADMIN")
