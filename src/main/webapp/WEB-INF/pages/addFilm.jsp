...
<div class="wrapper">
    ...
    <div class="contener">
        <div class="content">
            <div id='dle-content'>
                <form  method="post" name="addNewFilm" id="addNewFilm" action="/addNewFilm">
                    <div class="padding_border">
                        <table cellpadding="8" width="100%" style="font-size:14px!important; border:2px solid #272727; ">
                            ...
                            <tr>
                                ...
                                <td colspan="11" >
                                    <input type="text" name="filmPath" id='filmPath' class="f_input" value=""/>
                            ...
                            <tr>
                                ...
                                <td colspan="4" >
                                    <select id="filmYear" name="filmYear" class="f_select">
                                ...
                                <td colspan="4" >
                                    <select width="300px" id="filmCountry" name="filmCountry" class="f_select">
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <select id="filmQuality" name="filmQuality" class="f_select">
                            ...
                            <tr>
                                ...
                                <td colspan="11" >
                                    <select name="filmTranslation" id="filmTranslation" class="f_select">
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <c:forEach var="s" items="${genres}">
                                                <td width="20%">
                                                    <input type="checkbox" name="filmGenres[]" id="<c:out value="${s.code}" />" value="<c:out value="${s.code}" />" />&nbsp;<c:out value="${s.name}" />
                                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="17" >
                                    <input type="text" name="filmDatailDirector" id='filmDatailDirector' class="f_input" value=""/>
                                </td>
                            </tr>
                            <tr>
