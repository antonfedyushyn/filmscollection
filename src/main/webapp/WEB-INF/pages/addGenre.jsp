...
<div class="wrapper">
    ...
    <div class="contener">
        <div class="content">
            <div id='dle-content'>
                <form  method="post" name="addGenre" id="addGenre" action="/addGenre">
                    <div class="padding_border">
                        <table class="tableform">
                            ...
                            <tr>
                                ...
                                <td width="962">
                                    <input type="text" name="genreName" id="genreName" class="f_input" value=""/> &nbsp;
                                </td>
                            </tr>
                            <tr>
                                <td width="167" class="label">Код жанра:</td>
                                <td width="962">
                                    <input type="text" name="genreCode" id="genreCode" class="f_input" value=""/> &nbsp;
                                </td>
                            </tr>
                        </table>
