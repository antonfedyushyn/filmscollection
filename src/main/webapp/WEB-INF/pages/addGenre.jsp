...
<div class="wrapper">
    ...
    <div class="contener">
        <div class="content">
            <div id='dle-content'>
                <form  method="post" name="addGenre" id="addGenre" action="<c:url value="/addGenre"/>">
                    <div class="padding_border">
                        <table class="tableform">
                            <tr>
                                <td colspan="2" align="center">
                                    <p><b>Добавление нового жанра фильма</b></p>
                                </td>
                            </tr>
                            <tr>
                                <td width="167" class="label">Жанр:</td>
                                <td width="962">
                                    <input type="text" name="genreName" id="genreName" class="f_input" value="" title="Жанр"/> &nbsp;
                                </td>
                            </tr>
                            <tr>
                                <td width="167" class="label">Код жанра:</td>
                                <td width="962">
                                    <input type="text" name="genreCode" id="genreCode" class="f_input" value="" title="код жанра"/> &nbsp;
                                </td>
                            </tr>
                        </table>
        ...
        <span class="leftblok_contener">
            ...
            <span class="leftblok_contener2">
                ...
                <div class="leftblok2">
                    <div class="miniblock">
                        <div class="mini" style="border-top:0; padding-top:0;">
                            <i style="font-size:14px;">Жанры</i><br><br>
                            <div class="film_genres">
